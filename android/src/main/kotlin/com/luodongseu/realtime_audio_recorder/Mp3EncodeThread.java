...
public class Mp3EncodeThread extends Thread {
    ...
    private OnDataEncodedListener onDataEncodedListener;
    ...
    public void setOnDataEncodedListner(OnDataEncodedListener listner) {
        this.onDataEncodedListener = listner;
    }
    ...
    private void lameData(ChangeBuffer changeBuffer) {
        ...
        if (readSize > 0) {
            ...
            try {
                if (null != this.onDataEncodedListener) {
                    onDataEncodedListener.onEncodeData(Arrays.copyOfRange(mp3Buffer, 0, encodedSize));
                }
